...
export default function EmployeeAddTransaction() {
  ...
  return (
    <>
      <style>{`/* Place your CSS here or import it via CSS file for best practice */
// --- CSS omitted for brevity, use your <style> block content here ---`}</style>
      <aside className="sidebar">
        ...
        <nav>
          ...
          <a href="#" className="nav-link active" style={{ "--from-color": "var(--neon-green)", "--to-color": "var(--neon-blue)" }}>
          ...
          <a href="transactions.html" className="nav-link" style={{ "--from-color": "var(--neon-purple)", "--to-color": "var(--neon-pink)" }}>
          ...
          <a href="budget.html" className="nav-link" style={{ "--from-color": "var(--neon-orange)", "--to-color": "var(--neon-pink)" }}>
          ...
          <a href="approval.html" className="nav-link" style={{ "--from-color": "var(--neon-blue)", "--to-color": "var(--neon-green)" }}>
