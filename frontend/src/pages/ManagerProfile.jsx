...
export default function ManagerProfile() {
  ...
  // --- Handlers ---
  const handleEdit = () => {
    setTemp({ name: user.name, email: user.email });
    setIsEditing(true);
  };
  ...
  return (
    <>
      <style>{`/* Place your CSS from <style> here or import it in practice */
// --- For brevity, extract and use your provided style content!
`}</style>
      <aside className="sidebar">
        ...
        <nav>
          ...
          <a href="reports.html" className="nav-link" style={{"--from-color": "var(--neon-orange)", "--to-color": "var(--neon-pink)"}}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21.21 15.89A10 10 0 1 1 8 2.83" /><path d="M22 12A10 10 0 0 0 12 2v10z" /></svg><span>Reports</span></a>
        </nav>
        <div className="user-actions">
          <a href="#" className="nav-link action-button active" style={{"--from-color": "var(--neon-blue)", "--to-color": "var(--neon-purple)"}}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg><span>Profile</span></a>
      ...
      <main className="main-content">
        <div className="page-container">
          <header className="page-header animate-fade-in-up">
            <h1 className="font-cyber glow-text">MANAGER PROFILE</h1>
            <p className="subtitle">Manage your personal information and view stats</p>
          </header>
          <div className="profile-grid">
            ...
            <div className="profile-details cyber-card animate-fade-in-up" style={{animationDelay: "0.2s"}}>
              <div className="profile-details-header">
                ...
                {!isEditing && (
                  <button id="edit-btn" className="neon-button-secondary" onClick={handleEdit}>
                ...
                {isEditing && (
                  <div className="edit-controls">
                    <button type="button" id="save-btn" className="neon-button" onClick={handleSave}>
                    ...
                    <button type="button" id="cancel-btn" className="neon-button-secondary" onClick={handleCancel}>
                ...
                <div className="form-group">
                  ...
                  <div className="input-wrapper">
                    ...
                    <input
                      type="text"
                      id="name-input"
                      value={isEditing ? temp.name : user.name}
                ...
                <div className="form-group">
                  ...
                  <div className="input-wrapper">
                    ...
                    <input
                      type="email"
                      id="email-input"
                      value={isEditing ? temp.email : user.email}
              ...
              <div className="stats-section">
                <h4 style={{fontSize:"1.125rem", fontWeight:600, marginBottom:"1rem"}}>Manager Statistics</h4>
                <div className="stats-grid">
                  <div className="stat-box">
                    ...
                    <p className="value text-neon-green">{stats.teamSize}</p>
                  </div>
                  <div className="stat-box">
                    <div className="icon-container" style={{backgroundImage: "linear-gradient(to right,var(--neon-purple),var(--neon-pink))"}}>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2"><polyline points="9 11 12 14 22 4" /><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" /></svg>
                    </div>
                    <p className="label">Expenses Reviewed</p>
                    <p className="value text-neon-purple">{stats.expensesReviewed}</p>
                  </div>
                  <div className="stat-box">
                    ...
                    <p className="value text-neon-orange">{stats.approvalRate}</p>
                  </div>
                </div>
              </div>
            </div>
